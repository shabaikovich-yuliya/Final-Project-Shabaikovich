...
public class LoginPageXpath {
    ...
    public static final String ERROR_MESSAGE_EMAIL = "//*[@id='login-name-wrap']//*[@class='help-block form-error']";
    public static final String ERROR_MESSAGE_REQUIRED_PASSWORD = "//*[@id='login-pass-wrap']//*[@class='help-block form-error']";
    public static final String ERROR_MESSAGE_INVALID_LOGIN_DATA = "//*[@class='errors-login']";
}
